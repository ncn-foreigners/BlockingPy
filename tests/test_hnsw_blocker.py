...
def test_parameter_variations(hnsw_blocker, small_sparse_data, hnsw_controls, param_name, param_value):
...
def test_save_index(hnsw_blocker, small_sparse_data, hnsw_controls):
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        result1 = hnsw_blocker.block(x=x, y=y, k=1, verbose=False, controls=controls)
